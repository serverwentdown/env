{ vmType }:
{
  # https://github.com/abiosoft/colima/blob/c2934d438ca8854355a2b5fae8a792f269388287/embedded/defaults/colima.yaml
  ...
  mountType = if vmType == "vz" then "virtiofs" else "sshfs";
